...
/** @type {string} */
const CACHE_VERSION = '1731557192|14176179989';
/** @type {string} */
const CACHE_PREFIX = 'Roguelikepuzzle-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Roguelikepuzzle.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Roguelikepuzzle.html","Roguelikepuzzle.js","Roguelikepuzzle.offline.html","Roguelikepuzzle.icon.png","Roguelikepuzzle.apple-touch-icon.png","Roguelikepuzzle.worker.js","Roguelikepuzzle.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Roguelikepuzzle.wasm","Roguelikepuzzle.pck"];
